...
Math-Shepherd was the first major mathematical-reasoning RL paper, using a learned process reward model to train language models with step-by-step PPO.[@wang2024mathshepherd] DeepSeekMath introduced GRPO and was published on February 5, 2024; it stands as the first paper to apply verifier-driven RL to mathematical reasoning at LLM scale.
