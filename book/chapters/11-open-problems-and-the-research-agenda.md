...
Please cut off this figure so that it does not show the cheating rates on the right and only has the prime and non-prime examples, and then make it also dark mode compatible.
