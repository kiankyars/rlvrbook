...
Read [Chapter 8](chapters/08-reasoning-model-recipes.md), [Chapter 9](chapters/09-long-context-multimodal-and-agentic-rlvr.md), and [Chapter 10](chapters/10-open-problems-and-the-research-agenda.md).
...
Fortunately, we live in a world where AI slop writing is still *very* intelligible from genuine human text. It is knowing this fact, and also knowing that a textbook is still very much a human-lead endeavor that I write almost (I can guarantee you there are no EM dashes in the entire book) all of the sections on my own, or rather use Wispr Flow to dictate them and then edit them. The main contributions of Codex to this project were:
